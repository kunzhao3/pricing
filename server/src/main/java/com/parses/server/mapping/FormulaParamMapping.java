...
public enum FormulaParamMapping {
    ...
    settlementRate("结算利率", "settlementRate", "0.00","资方或担保方结算利率"),
    floatingRate("浮动利率", "floatingRate", "0.00","资方浮动利率"),
    fixedRate("固定利率", "fixedRate", "0.00","服务费结算固定利率"),
    repaymentWay("加速到期时:利息计算方式", "repaymentWay", "2","1:等本等息,2:等额本息;只有信托(中融,华润)等本等息"),
    quickenDayRate("加速到期时:费项计算日利率", "quickenDayRate", "0.00","A等级-0.065%,BCD等级-0.098%"),
